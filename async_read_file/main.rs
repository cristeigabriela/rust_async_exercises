use std::{ffi::OsStr, os::windows::ffi::OsStrExt, pin::Pin, task::Poll};
...
fn async_read_file(path: impl AsRef<str>) -> impl Future<Output = Result<Vec<u8>, Error>> {
...
async fn main() -> Result<(), Error> {
    ...
    println!("Succesful read! Quoted print...\n\"{file}\"");
